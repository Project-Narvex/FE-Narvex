...
import { Palette, GraduationCap, Lightbulb, Heart, Instagram, ExternalLink, LucideIcon } from 'lucide-react';
...
interface Company {
  ...
  tagline: string;
  description: string;
  icon: string; // Now a string identifier instead of component
  color: string;
  instagram: string;
  website: string;
  services: string[];
